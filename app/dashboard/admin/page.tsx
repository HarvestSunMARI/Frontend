      ...
      <div className="p-6">
        <div className="space-y-6">
          <div>
            ...
            <p className="text-earth-brown-700 text-lg">Welcome back, {user?.name}</p>
          </div>
          {/* Summary Cards */}
                    ...
                    <div key={log.id} className="flex items-start gap-3 p-3 bg-earth-green-50 rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-earth-brown-500 mt-1">
                          {log.timestamp.toLocaleDateString('id-ID')} 2 {log.ip}
                        </p>
                      </div>
                    </div>
                  ))}
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <button className="p-4 bg-red-100 hover:bg-red-200 rounded-lg text-left transition-colors">
                  ...
                  <h3 className="font-medium text-earth-brown-800">Kelola Laporan</h3>
                  <p className="text-sm text-earth-brown-600">Kelola laporan</p>
                </button>
              </div>
            </CardContent>
          </Card>
